function [s,profile,f_env,t_env,SList,th,fr] = multimvripfft1_new(rippleList, cond,comp_phs_file,theta,freq,XkV)
...
if nargin < 4
    if PhFlag == 3
        error('Input phase vector or set PhFlag to 0')
    end
end
